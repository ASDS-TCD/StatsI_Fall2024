...
\begin{enumerate}
   ...
   \lstinputlisting[language=R, firstline=35, lastline=61]{PS01.J.L.R}  
	\item Next, the school counselor was curious  whether  the average student IQ in her school is higher than the average IQ score (100) among all the schools in the country.\\ 
	\noindent Using the same sample, conduct the appropriate hypothesis test with $\alpha=0.05$.
		\lstinputlisting[language=R, firstline=64, lastline=82]{PS01.J.L.R}  
\end{enumerate}
...
\lstinputlisting[language=R, firstline=88, lastline=119]{PS01.J.L.R}  
...
\vspace{.2cm}
\lstinputlisting[language=R, firstline=122, lastline=130]{PS01.J.L.R} 
...
\vspace{.2cm}
\lstinputlisting[language=R, firstline=132, lastline=150]{PS01.J.L.R} 
\end{itemize}
